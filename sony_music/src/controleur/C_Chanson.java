...
public class C_Chanson {
	...
	public static Chanson selectWhereChanson(String titre, String sortie, String duree, int idAlbum, int idCategorie) {
		//on controle les donn�es
		return ModeleChanson.selectWhereChanson(titre, sortie, duree, idAlbum, idCategorie);
	}
