...
public class PanelChansons extends PanelPrincipal implements ActionListener{
	...
	public PanelChansons() {
        ...
        String entetes [] = {"IdChanson", "Titre", "Sortie", "Durée", "IdCatégorie", "IdAlbum"};
	...
	public Object[][] obtenirChansons(){
		...
		Object[][] matrice= new Object[lesChansons.size()][6];
		int i=0;
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==this.btAnnuler) {
			...
			Chanson uneChanson= new Chanson(titre, sortie, duree, idCategorie, idAlbum);
			C_Chanson.insertIntervention(uneChanson);
			//On insère dans le tableau
			uneChanson=C_Chanson.selectWhereChanson(titre, sortie, duree, idAlbum, idCategorie);
			int idChanson=uneChanson.getIdchanson();
			
			Object[] ligne= {idChanson, titre, sortie, duree, idCategorie, idAlbum};
